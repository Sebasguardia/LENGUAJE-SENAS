        ...
        <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center relative overflow-hidden font-sans">
            ...
            <div className="relative z-10 w-full max-w-4xl px-6 text-center">
                ...
                <div className="relative mb-16 inline-block">
                    ...
                    {/* Decorative Elements */}
                    <div className="absolute -top-10 -left-10 w-20 h-20 border border-white/5 rounded-full animate-ping"></div>
                    <div className="absolute -bottom-8 -right-8 w-16 h-16 border border-white/5 rounded-full animate-ping delay-500"></div>
                </div>
